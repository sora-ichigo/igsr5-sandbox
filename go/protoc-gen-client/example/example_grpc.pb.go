...
type ExampleServiceClient interface {
	Echo(ctx context.Context, in *Example, opts ...grpc.CallOption) (*Example, error)
}
...
func (c *exampleServiceClient) Echo(ctx context.Context, in *Example, opts ...grpc.CallOption) (*Example, error) {
	out := new(Example)
...
type ExampleServiceServer interface {
	Echo(context.Context, *Example) (*Example, error)
}
...
func (UnimplementedExampleServiceServer) Echo(context.Context, *Example) (*Example, error) {
...
func _ExampleService_Echo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExampleServiceServer).Echo(ctx, req.(*Example))
	}
